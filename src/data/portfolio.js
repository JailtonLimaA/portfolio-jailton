export const companies = [
  {
    name: "Exmed",
    logo: "/images/logo-exmed.svg",
  },
  {
    name: "Excelsior Seguros",
    logo: "/images/logo-excelsior.svg",
  },
  {
    name: "Jofi",
    logo: "/images/logo-jofi.svg",
  },
];
...
export const designSystems = [
...

  {
    title: "Dexter",
    description:
      "Biblioteca de componentes e padrões criada para acelerar a construção de novas experiências.",
    image: "/images/dexter-cover.png",
  },
];
...
export const processSteps = [
  {
    ...
    title: "Entender",
    description:
      "Contexto, usuários, necessidades, restrições e objetivos do produto.",
  },
  {
    number: "02",
    title: "Explorar",
    description:
      "Pesquisa, referências, hipóteses e possíveis caminhos para o problema.",
  },
  {
    number: "03",
    title: "Definir",
    description:
      "Organização das informações e definição das principais decisões.",
  },
  {
    number: "04",
    title: "Projetar",
    description:
      "Fluxos, wireframes, interfaces e protótipos.",
  },
  {
    number: "05",
    title: "Validar",
    description:
      "Testes, feedbacks, ajustes e evolução contínua da solução.",
  },
];